...
function wpcrm_scripts_styles($hook) {
	...
	if ( in_array( $post_type, $postTypes ) || 'wpcrm-invoice' == $post_type || 'wpcrm-settings' == $active_page ) {
		...
		//wp_register_script( 'wp_crm_chosen_proto_js', WP_CRM_SYSTEM_PLUGIN_URL . '/js/chosen_v1.6.2/chosen.proto.min.js', array( 'jquery' ), WP_CRM_SYSTEM_VERSION, false );
		//wp_enqueue_script( 'wp_crm_chosen_proto_js' );
